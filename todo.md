...
**Versioning:** `v0.5.1` is **released** (Library handoff fixes); `v0.5.0`
introduced the annotation library and `v0.4.1` came before it. `package.json`
sits at `0.5.1` until the next change.
