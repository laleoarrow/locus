...
pnpm build:e2e && npx playwright test   # Playwright, currently 33
...
**Versioning:** `v0.6.1` is the current release (compact Library cards, live
site filters and site families); `v0.6.0` added page-scoped
palettes and selection batch deletion. `package.json` sits at `0.6.1`.
